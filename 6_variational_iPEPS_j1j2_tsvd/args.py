...
parser.add_argument("-tsvd_extra", type=int, default=0, help="number of extra sing. values computed in TSVD")
parser.add_argument("-ctm_threshold", type=float, default=None, help="stopping criterion for CTM")
